    ...
    <section className="w-full py-24 px-6 md:px-8 bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative group cursor-pointer flex flex-col justify-center items-center px-6 py-8 rounded-2xl bg-slate-900 text-white text-center shadow-xl transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-600/30 hover:bg-slate-800 border border-slate-800 hover:border-blue-500/50">
